...
const HowItWorks = () => {
  ...
  return (
    <section className="bg-primary-50/50" id="howItWorks">
      <div className="section-container">
        <SectionHeader
          subheading="How It Works"
          heading=" We make your travel visa process smooth, stress-free, and fast"
          align="left"
          responsive={true}
        />
        <div className="grid grid-cols-8 gap-y-6 md:gap-8 lg:gap-12">
          {HowItWorksData.map((item, index) => (
            <React.Fragment key={item.step}>
              <div className="card items-center text-center md:text-left md:items-start col-span-8 lg:col-span-2">
